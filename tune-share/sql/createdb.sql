...
CREATE TABLE TuneShareDB.Images (
    ...
    type ENUM('artist', 'album', 'song') NOT NULL, -- To identify the type of image
    reference_id INT NOT NULL,                    -- Foreign key to reference the artist, album, or song
    url VARCHAR(255) NOT NULL                     -- URL or path to the image file
);
